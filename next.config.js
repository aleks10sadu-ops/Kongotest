...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/dostavka', destination: '/menu#main', permanent: true },
      ...
      { source: '/biznes-lanch', destination: '/menu#business', permanent: true },
        ...
        headers: [
          ...
          ...(process.env.NODE_ENV === 'production' ? [{
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net https://yastatic.net https://*.yastatic.net https://k-c-reservations.vercel.app https://*.vercel.app https://vercel.live https://*.vercel.live https://va.vercel-scripts.com wss://*.pusher.com https://*.pusher.com",
              "media-src 'self'",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
