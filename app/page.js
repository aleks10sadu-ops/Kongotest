...
import { Menu, X, Clock, MapPin, Phone, ShoppingCart } from 'lucide-react';

const menuItems = [
  { id: 1, name: 'Подвешенная на кости оленина', description: 'с древесными грибами и чёрным чесноком', price: 870, image: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400&h=300&fit=crop', category: 'Основные блюда' },
  { id: 2, name: 'Салат с копчёной олениной', description: 'голубикой и сосновыми шишками', price: 840, image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop', category: 'Салаты' },
  { id: 3, name: 'Стейк Рибай', description: 'Сочный стейк из мраморной говядины с овощами гриль', price: 2500, image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=300&fit=crop', category: 'Основные блюда' },
  { id: 4, name: 'Паста с морепродуктами', description: 'Домашняя паста с тигровыми креветками и мидиями', price: 1200, image: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=400&h=300&fit=crop', category: 'Основные блюда' },
  { id: 5, name: 'Тирамису', description: 'Классический итальянский десерт с маскарпоне', price: 450, image: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=400&h=300&fit=crop', category: 'Десерты' },
  { id: 6, name: 'Томленая щека быка', description: 'с овощами и пряными травами', price: 1850, image: 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=400&h=300&fit=crop', category: 'Основные блюда' }
];
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea placeholder="Особые пожелания" rows="3" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-orange-600 focus:outline-none"></textarea>
                  </div>
                  <button
                    type="submit"
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <form className="space-y-4">
                  ...
                  <textarea placeholder="Сообщение" rows="4" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-orange-600 focus:outline-none"></textarea>
