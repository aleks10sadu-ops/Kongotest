 ...
 * @param {Object} props
 * @param {boolean} props.isOpen - открыта ли корзина
 * @param {Function} props.onClose - закрытие корзины
 * @param {Array} props.items - элементы корзины
 * @param {Function} props.onAdd - добавление элемента
 * @param {Function} props.onDecrement - уменьшение количества
 * @param {Function} props.onRemove - удаление элемента
 * @param {number} props.count - общее количество товаров
 * @param {number} props.total - общая сумма
 * @param {Function} props.onDeliveryClick - открытие формы доставки
 * @param {Object} props.businessLunchValidation - валидация бизнес-ланча
 * @param {boolean} props.isMounted - флаг монтирования
 */
 ...
 * Элемент корзины
 */
function CartItem({ item, onAdd, onDecrement, onRemove }) {
  return (
