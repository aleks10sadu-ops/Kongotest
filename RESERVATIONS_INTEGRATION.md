...
2. **CORS проблемы**
   ...
   - **Важно:** Если вы видите ошибку CORS, но бронирование все равно создается (статус 201 в консоли), это означает, что запрос успешен, но сервер не отправляет правильные CORS заголовки. В этом случае форма все равно покажет успех, так как бронирование было создано.
